	...
	private function __construct(){
		...
		*/
		...
		if(1 == $_SESSION["game_type"]){
			$sea = array(0,1,2,3,4,5,7,8,9,10,11,12,13,14,24,25,26,39,52,65,90,91,104,117,130,38,51,64,77,103,116,129,142,143,144,154,155,156,157,158,159,160,161,162,163,164,165,166,167,168);
			$ship = array(6, 78);
		}else{
